<x-layouts.app>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 relative border border-dashed border-sepia-edge/30">
                <div class="flex flex-col justify-center">
                    <div class="flex items-center gap-2 mb-3">
                        <x-lucide-sparkles class="w-6 h-6 text-coffee" />
                        <span
                    ...
                    <h1 class="text-4xl font-black text-ink mb-4 uppercase tracking-wide leading-tight">
                        Selamat Datang,<br>
                        <span class="italic font-serif">Ahmad Santoso</span>
                    </h1>
                    ...
                    <div class="mt-8 flex gap-4 flex-wrap">
                        <a href="/guest/book-explorer"
                            ...
                            <x-lucide-search class="w-4 h-4 stroke-[2]" />
                            Jelajahi Koleksi
                        </a>
                        <a href="/member/wishlist"
                            ...
                            <x-lucide-bookmark class="w-4 h-4 stroke-[2]" />
                            Daftar Wishlist
                        </a>
                    </div>
                </div>
                ...
                <div class="hidden md:flex items-center justify-center">
                    <div class="relative w-48 h-48 flex items-center justify-center">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=160&h=160&fit=crop&crop=face"
                            alt="Ahmad Santoso"
    ...
    <section class="mb-12">
        <div class="flex items-center gap-3 mb-6 border-b-2 border-double border-sepia-edge/40 pb-2">
            <x-lucide-chart-pie class="w-6 h-6 text-ink stroke-[1.5]" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div
                ...
                <div class="flex items-center justify-between mb-4 border-b border-dashed border-ink/20 pb-2">
                    ...
                    <x-lucide-circle-user-round class="w-5 h-5 text-ink/60" />
                </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4 border-b border-dashed border-ink/20 pb-2">
                    ...
                    <x-lucide-bookmark class="w-5 h-5 text-yellow-600/60" />
                </div>
                <div class="text-4xl font-black text-ink font-serif">12</div>
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4 border-b border-dashed border-ink/20 pb-2">
                    ...
                    <x-lucide-wallet class="w-5 h-5 text-ink/60" />
                </div>
                <div class="text-2xl font-black font-mono text-ink tracking-tighter">Rp150.000</div>
    ...
    <section class="border-4 border-double border-sepia-edge/40 bg-[#fcfaf5] p-8 shadow-sm">
        <div class="flex items-center gap-3 mb-8 pb-3 border-b-2 border-ink">
            <x-lucide-info class="w-7 h-7 text-ink stroke-[1.5]" />
